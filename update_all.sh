...
# # Generate the data
# python3 strategy_visualizations.py -d &
# python3 strategy_visualizations.py -d -n 0.05 &
# wait
#
# # Strategy Visualizations
# echo "Score Visualizations, no noise (in background process)"
# python3 strategy_visualizations.py -t 200 -r 100 -n 0.00 -f s &
# echo "Score Difference Visualizations, no noise (in background process)"
# python3 strategy_visualizations.py -t 200 -r 100 -n 0.00 -f sd &
# echo "Cooperation Visualizations, no noise (in background process)"
# python3 strategy_visualizations.py -t 200 -r 100 -n 0.00 -f c &
# echo "Opponent Cooperation Visualizations, no noise (in background process)"
# python3 strategy_visualizations.py -t 200 -r 100 -n 0.00 -f oc &
#
# wait
#
# # Strategy Visualizations
# echo "Cooperation Visualizations, 0.05 noise (in background process)"
# python3 strategy_visualizations.py -t 200 -r 100 -n 0.05 -f c &
...
python example_tournaments.py -t 200 -r 50 -n 0.05 -p 4 -a
